        ...
        <div className="py-12 md:py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="font-body text-muted-foreground text-sm md:text-base max-w-sm leading-relaxed mb-6">
                {branding.tagline}
              </p>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-display text-foreground font-semibold mb-6 text-sm uppercase tracking-wider">
                Quick Links
              </h4>
